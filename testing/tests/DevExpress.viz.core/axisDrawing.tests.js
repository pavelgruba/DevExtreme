...
QUnit.test("Horizontal top. Position inside", function(assert) {
    ...
    assert.deepEqual(renderer.text.getCall(0).returnValue.attr.getCall(2).args[0], { translateX: 40 - 1 - 12 / 2, translateY: 30 + 10 - 2 }, "Text args");
    assert.deepEqual(renderer.text.getCall(1).returnValue.attr.getCall(2).args[0], { translateX: 60 - 3 - 14 / 2, translateY: 30 + 10 - 4 }, "Text args");
});
...
QUnit.test("Horizontal Bottom. Position inside", function(assert) {
    ...
    assert.deepEqual(renderer.text.getCall(0).returnValue.attr.getCall(2).args[0], { translateX: 40 - 1 - 12 / 2, translateY: 70 - 10 - 6 - 2 }, "Text args");
    assert.deepEqual(renderer.text.getCall(1).returnValue.attr.getCall(2).args[0], { translateX: 60 - 3 - 14 / 2, translateY: 70 - 10 - 8 - 4 }, "Text args");
});
...
QUnit.test("Vertical left. Position inside", function(assert) {
    ...
    assert.deepEqual(renderer.text.getCall(0).returnValue.attr.getCall(2).args[0], { translateX: 10 + 10 - 1, translateY: 40 - 2 - 6 / 2 }, "Text args");
    assert.deepEqual(renderer.text.getCall(1).returnValue.attr.getCall(2).args[0], { translateX: 10 + 10 - 3, translateY: 60 - 4 - 8 / 2 }, "Text args");
});
...
QUnit.test("Vertical right. Position inside", function(assert) {
    ...
    assert.deepEqual(renderer.text.getCall(0).returnValue.attr.getCall(2).args[0], { translateX: 90 - 10 - (1 + 12), translateY: 40 - 2 - 6 / 2 }, "Text args");
    assert.deepEqual(renderer.text.getCall(1).returnValue.attr.getCall(2).args[0], { translateX: 90 - 10 - (3 + 14), translateY: 60 - 4 - 8 / 2 }, "Text args");
});
